...
if __name__ == '__main__':
	...
	parser.add_argument('-d', "--data_directory", help='Specify the dataset directory path')
	parser.add_argument('-e', "--exp_directory", help='Specify the experiment directory where metrics and model weights shall be stored.')
	parser.add_argument("--epochs", default=25, type=int)
	parser.add_argument("--batchsize", default=4, type=int)
	args = parser.parse_args()

# Example: python main.py -d ../../dataverse/sign-masks/deeplabv3_data/ -e ../deeplabv3-benchmark/
...
# Create the dataloader
	dataloaders = datahandler.get_dataloader_single_folder(data_dir, imageFolder='Image', maskFolder='Mask', fraction=0.1, batch_size=batchsize)
